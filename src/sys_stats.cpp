#include <chrono>
#include <thread>
#include "cpp-linux-system-stats/include/linux-system-usage.hpp"
...
int main(int argc, char * argv[]){
    ...
    for(int i=0; i<time; i++){
        ...
        usage[0][i] = 100.0f * get_cpu_usage(t1, t2);
        ...
        usage[1][i] = memory_data.total_memory/1024/1024 * memory_data.get_memory_usage();
